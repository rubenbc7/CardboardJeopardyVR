...
public class Acierto : MonoBehaviour
{
    ...
    [SerializeField] GameObject Dinero;
    [SerializeField] GameObject musicaGanar;
    [SerializeField] GameObject musicaX;
    [SerializeField] GameObject sfxGanar;
    [SerializeField] GameObject btnReiniciar;
    ...
    {
        puntuacion.puntos++;
		puntuaciones.GetComponent<Text>().text="Cash: $18,000";
        ...
        sfxGanar.SetActive(true);
        musicaX.SetActive(false);
    ...
    IEnumerator Cash(){
        puntuacion.puntos++;
        puntuaciones.GetComponent<Text>().text="Cash: $" + (18,000 + puntuacion.puntos);
        yield return null; 
    }
    IEnumerator Audio(){
